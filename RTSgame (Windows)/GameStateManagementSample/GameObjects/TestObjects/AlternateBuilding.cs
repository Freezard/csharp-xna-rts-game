...
namespace RTSgame.GameObjects
{
    ...
    class AlternateBuilding : ModelObject
    {
        public AlternateBuilding(Vector2 position)
            : base(position, new ModelComponent("factory"))
        {
            ...
            ParticleManager.GetInstance().AddSmoke1(Calculations.V2ToV3(position + new Vector2(0.65f, 0.4f), 2.8f));
            ParticleManager.GetInstance().AddSmoke1(Calculations.V2ToV3(position + new Vector2(0.65f, -0.3f), 2.8f));

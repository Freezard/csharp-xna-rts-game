        ...
        private void CreateHeightMap()
        {
            ...
            for (int x = 0; x < XDimension; x++)
            {
                for (int z = 0; z < YDimension; z++)
                {
                    ...
                    {
                        // Add triangle 1
                        SetUniformNormalAndAddV3(ref vUpLeft, ref vDownRight, ref vDownLeft, noise);
                        AddTriangle(vUpLeft, vDownRight, vDownLeft);

                        // Add triangle 2
                        SetUniformNormalAndAddV3(ref vUpLeft, ref vUpRight, ref vDownRight, noise);
                        AddTriangle(vUpLeft, vUpRight, vDownRight);
                    }
                    else
                    {
                        // Add triangle 1
                        SetUniformNormalAndAddV3(ref vUpLeft, ref vUpRight, ref vDownLeft, noise);
                        AddTriangle(vUpLeft, vUpRight, vDownLeft);

                        // Add triangle 2
                        SetUniformNormalAndAddV3(ref vUpRight, ref vDownRight, ref vDownLeft, noise);

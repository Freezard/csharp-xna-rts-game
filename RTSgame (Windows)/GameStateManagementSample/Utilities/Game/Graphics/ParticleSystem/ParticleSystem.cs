...
namespace RTSgame.Utilities.Graphics.ParticleSystem
{
    ...
    public abstract class ParticleSystem
    {
        ...
        /// Constructor.
        /// </summary>
        protected ParticleSystem(GraphicsDevice graphics)
        {
        ...
        {
            settings.EmitterVelocitySensitivity = settings.BaseEmitterVelocitySensitivity * scale;
            settings.MinHorizontalVelocity = settings.BaseMinHorizontalVelocity * scale;
            settings.MaxHorizontalVelocity = settings.BaseMaxHorizontalVelocity * scale;
            settings.MinVerticalVelocity = settings.BaseMinVerticalVelocity * scale;
            settings.MaxVerticalVelocity = settings.BaseMaxVerticalVelocity * scale;
            settings.MinStartSize = settings.BaseMinStartSize * scale;
            settings.MaxStartSize = settings.BaseMaxStartSize * scale;
            settings.MinEndSize = settings.BaseMinEndSize * scale;
            settings.MaxEndSize = settings.BaseMaxEndSize * scale;
        }

        /// <summary>
        /// Updates the max particles.
        /// </summary>
        ...
        {
            Effect effect = AssetBank.GetInstance().GetShader("ParticleEffect");
            ...
            Texture2D texture = AssetBank.GetInstance().GetTexture(settings.TextureName);
        ...
        public void Draw()
        {
            ...
            if (firstActiveParticle != firstFreeParticle)
            {
                ...
                effectViewportScaleParameter.SetValue(new Vector2(2.5f / device.Viewport.AspectRatio, -2.5f));
        ...
        public void AddParticle(Vector3 position, Vector3 velocity)
        {
            ...
            StartSize.X = settings.MinStartSize;
            StartSize.Y = settings.MaxStartSize;
            EndSize.X = settings.MinEndSize;
            EndSize.Y = settings.MaxEndSize;
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                particles[firstFreeParticle * 4 + i].StartSize = StartSize;
                particles[firstFreeParticle * 4 + i].EndSize = EndSize;
            }

...
namespace RTSgame.Utilities.Graphics.ParticleSystem
{
    ...
    public class ParticleSettings
    {
        ...
        public float BaseEmitterVelocitySensitivity = 1;
        ...
        public float BaseMinHorizontalVelocity = 0;
        public float MaxHorizontalVelocity = 0;
        public float BaseMaxHorizontalVelocity = 0;
        ...
        public float BaseMinVerticalVelocity = 0;
        public float MaxVerticalVelocity = 0;
        public float BaseMaxVerticalVelocity = 0;
        ...
        public float BaseMinStartSize = 100;
        public float MaxStartSize = 100;
        public float BaseMaxStartSize = 100;
        ...
        public float BaseMinEndSize = 100;
        public float MaxEndSize = 100;
        public float BaseMaxEndSize = 100;

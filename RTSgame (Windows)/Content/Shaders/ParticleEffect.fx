...
struct VertexShaderInput
{
	...
	float2 StartSize : POSITION2;
	float2 EndSize : POSITION3;
...
float ComputeParticleSize(float randomValue, float normalizedAge, float2 StartSize, float2 EndSize)
{
...
VertexShaderOutput ParticleVertexShader(VertexShaderInput input)
{
    ...
    float size = ComputeParticleSize(input.Random.y, normalizedAge, input.StartSize, input.EndSize);
